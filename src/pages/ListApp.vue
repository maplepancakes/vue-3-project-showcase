<template>
  <div class="w-full flex mt-10">
    <div class="m-auto border p-10">
      <h1 class="text-3xl text-center font-bold text-gray-400">List App</h1>
      <ul class="mt-5">
        <li v-for=" list in listing" :key="list" class="flex justify-between">
          {{ list }}
